...
window.api.receive("loadFrames", (data) => {
	parseData(data);
	renderMain();
});
...
function renderMain(project = "") {
	...
	if (project == "") document.getElementById("filePath").innerHTML = filePath;
	else document.getElementById("filePath").innerHTML = project;
